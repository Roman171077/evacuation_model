...
from src.catalog import get_profile_color
from src.model import Person, PersonVisualPlacement, SectionVisual, Segment, Snapshot
from src.row_layout import build_rows_on_section, compute_person_row_centers
...
def draw_group_legend(ax: plt.Axes) -> None:
    require_matplotlib()
    from src.catalog import MOBILITY_GROUP_COLORS
